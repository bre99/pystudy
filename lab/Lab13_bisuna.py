...
print("The Employee name is",myEmployee.get_name(),"with",myEmployee.get_hours(),
      "hours worked at a rate of",myEmployee.get_rate(),"per hour.")
print("The Employee name is",myEmployee1.get_name(),"with",myEmployee1.get_hours(),
      "hours worked at a rate of",myEmployee1.get_rate(),"per hour.")
